//решение через обычные указатели, меньше по памяти, но очень много утекает
#include <iostream>
#include <tuple>
#include <vector>
#include <algorithm>
...
int main() {
    ...
    int n, m;
    std::vector<Segment> arr_segment; //координата х, координата y, левый или правый х (вставка или удаление bool)
    std::cin >> n >> m;
    ...
    //стабильная сортировка точек, чтобы дополнительно сначала шли добавления точек, а затем удаление, если x одинаковый
    ...
    // std::mt19937 gen(42);  //для рандомных значений приоритета
