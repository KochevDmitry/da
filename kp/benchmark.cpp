...
Node* insert(Node* root, Point* point_left, Point* point_right, int priority) {
    ...
    if (point_left->y < root->point_left->y || ((point_left->y == root->point_left->y)&&(point_right->y < root->point_right->y))) {
...
Node* remove(Node* root, Point* point_left, Point* point_right) {
    ...
    } else if (point_left->y > root->point_left->y || ((point_left->y == root->point_left->y)&&(point_right->y > root->point_right->y))) {
...
int main(){
    ...
    // for (int i = 0; i < versions.size(); i += 35) {
